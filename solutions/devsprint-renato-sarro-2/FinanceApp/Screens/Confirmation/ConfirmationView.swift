...
class ConfirmationView: UIView {
   ...
   lazy var niceConfirmation: UIButton = {
    ...
    NSLayoutConstraint.activate([
        imageConfirmation.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: 250),
        imageConfirmation.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 60),
        imageConfirmation.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -60),
        imageConfirmation.heightAnchor.constraint(equalToConstant: 200)
    ])
}
