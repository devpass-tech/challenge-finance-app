...
struct FinanceService: FinanceServiceProtocol {
    ...
    func load<T>(
        ...
        guard let url = URL(string: "https://raw.githubusercontent.com/devpass-tech/challenge-finance-app/main/api/\(endpoint.rawValue).json") else { return completion(.failure(.invalidURL)) }
